 ...
 * → logApplicationReady → application_ready 日誌}。
 *
...
public class OperationalStatusLogger {
	...
	public OperationalStatusLogger(@Value("${app.public-base-url:}") String publicBaseUrl) {
	...
	public void logApplicationReady() {
		// 日誌：記錄應用程式啟動完成與設定狀態。
		log.info(
			"event=application_ready requestId=startup publicBaseUrlConfigured={}",
